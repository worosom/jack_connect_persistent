...
void port_registration_cb (jack_port_id_t port, int register, void* arg)
{
    clientNotify();
}

void port_connect_cb (jack_port_id_t a, jack_port_id_t b, int connect, void *arg)
{
    clientNotify();
}

void update_ports (char *argv[]) {
